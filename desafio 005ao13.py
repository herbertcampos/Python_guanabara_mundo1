...
print(f'{n5} metros equivale á {n5*100} centimetros e equivale á {n5*1000} milimetros')
...
print(f'Com {n7} reais é possivel comprar {n7/3.27} dolares')

n8 = int(input('Digite a largura da parede: ')) #exercicio11
n9 = int(input('Digite a altura da parede: '))
areaparede = n8*n9
print(f'A àrea da parede é: {areaparede} metros')
print(f'Você precisa de {areaparede/2} litros de tinta para pintar a parede.')

n10 = int(input('Digite o preço do produto: ')) #exercicio12
